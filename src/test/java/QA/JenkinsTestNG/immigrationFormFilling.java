...
public class immigrationFormFilling {
	@Test
	public void immigration() {
	     ...
	     WebElement immiTabView = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='orangehrm-action-header']")));
